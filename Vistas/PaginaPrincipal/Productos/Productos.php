...
<html>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div class="ml-2 mt-5 row align-items-center">
                <div class="col-lg">
                    <div class="ml-2 mt-5 row align-items-center">
                        <div class="col-xs">
                            <h2 class="ml-5">
                                Podrás encontrar en nuestro <br> catálogo lo siguiente:
                            </h2>
                        </div>
                    </div>
                    <div class="ml-5 mt-3 row align-items-center">
                        <div class="col-xs">
                            <ul class="list-group list-group-horizontal">
                                <li class="list-group-item"> Antibióticos </li>
                                <li class="list-group-item"> Ansiolíticos </li>
                                <li class="list-group-item"> Analgésicos </li>
                                <li class="list-group-item"> Laxantes </li>
                                <li class="list-group-item"> Entre otros </li>
                            </ul>
                        </div>
                    </div>
                </div>
