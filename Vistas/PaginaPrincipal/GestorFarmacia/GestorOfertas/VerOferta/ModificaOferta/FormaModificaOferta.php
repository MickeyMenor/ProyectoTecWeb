<div class="col-sm">
    <form class="mt-5 ml-5" enctype="multipart/form-data" method="post" action="/ProyectoTecWeb/Vistas/PaginaPrincipal/GestorFarmacia/GestorOfertas/VerOferta/ModificaOferta/ModificaOferta.php">
        <?php
            $controlador->agregaIdOferta();
        ?>
