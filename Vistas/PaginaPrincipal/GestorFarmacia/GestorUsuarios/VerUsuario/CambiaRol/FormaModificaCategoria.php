<div class="col-sm">
    <form class="mt-5 ml-5" enctype="multipart/form-data" method="post" action="/ProyectoTecWeb/Vistas/PaginaPrincipal/GestorFarmacia/GestorCategorias/VerCategoria/ModificaCategoria/ModificaCategoria.php">
        <?php
            $controlador->agregaIdCategoria();
        ?>
