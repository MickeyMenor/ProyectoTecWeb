<div class="col-sm">
    <form class="mt-5 ml-5" enctype="multipart/form-data" method="post" action="/ProyectoTecWeb/Vistas/PaginaPrincipal/GestorFarmacia/GestorProductos/VerProducto/ModificarProducto/ModificarProducto.php">
        <?php
            $controlador->agregaIdMedicamento();
        ?>
        ...
        <div class="row align-items-center">
            <div class="mt-3 col-xs">
                <input class="btn btn-primary" name="boton" type="submit" style="margin-top: 20px;" value="Modificar">
            </div>
        </div>
    </form>
</div>